...
(assert (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!1))
...
(assert (not (fp.lt ((_ to_fp 11 53) x_ackermann!4) ((_ to_fp 11 53) x_ackermann!3))))
(assert (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))
    (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!3))))
(assert (fp.gt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!0)))
(assert (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!4))))
(assert (let ((a!1 (and (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!2)))
                (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))
                    (fp.isNaN ((_ to_fp 11 53) x_ackermann!2))
                    (fp.gt ((_ to_fp 11 53) x_ackermann!0)
                           ((_ to_fp 11 53) x_ackermann!2))))))
  (not a!1)))
; End constraints
(check-sat)
(exit)
