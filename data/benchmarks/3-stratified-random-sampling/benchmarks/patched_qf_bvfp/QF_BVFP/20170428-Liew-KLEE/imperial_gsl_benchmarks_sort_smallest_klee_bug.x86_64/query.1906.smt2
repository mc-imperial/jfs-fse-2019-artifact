...
(assert (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!3))
    ...
    (fp.lt ((_ to_fp 11 53) x_ackermann!3) ((_ to_fp 11 53) x_ackermann!0))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ackermann!3) ((_ to_fp 11 53) x_ackermann!2))))
(assert (fp.gt ((_ to_fp 11 53) x_ackermann!3) ((_ to_fp 11 53) x_ackermann!1)))
...
(assert (not (fp.gt ((_ to_fp 11 53) x_ackermann!4) ((_ to_fp 11 53) x_ackermann!1))))
(assert (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!3))
    (fp.lt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!3))))
...
(assert (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))
    (fp.gt ((_ to_fp 11 53) x_ackermann!4) ((_ to_fp 11 53) x_ackermann!5))))
(assert (not false))
; End constraints
(check-sat)
(exit)
