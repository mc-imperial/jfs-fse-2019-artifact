...
(assert (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!0))
    (fp.lt ((_ to_fp 11 53) x_ackermann!1) ((_ to_fp 11 53) x_ackermann!0))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ackermann!1) ((_ to_fp 11 53) x_ackermann!2))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ackermann!1) ((_ to_fp 11 53) x_ackermann!3))))
...
(assert (not (fp.gt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!3))))
(assert (not (fp.gt ((_ to_fp 11 53) x_ackermann!5) ((_ to_fp 11 53) x_ackermann!1))))
(assert (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!1))))
(assert (fp.gt ((_ to_fp 11 53) x_ackermann!0) ((_ to_fp 11 53) x_ackermann!2)))
(assert (not (fp.gt ((_ to_fp 11 53) x_ackermann!3) ((_ to_fp 11 53) x_ackermann!0))))
...
(assert (let ((a!1 (and (not (fp.isNaN ((_ to_fp 11 53) x_ackermann!5)))
                (or (fp.isNaN ((_ to_fp 11 53) x_ackermann!5))
                    (fp.gt ((_ to_fp 11 53) x_ackermann!1)
                           ((_ to_fp 11 53) x_ackermann!5))))))
  (not a!1)))
; End constraints
(check-sat)
(exit)
