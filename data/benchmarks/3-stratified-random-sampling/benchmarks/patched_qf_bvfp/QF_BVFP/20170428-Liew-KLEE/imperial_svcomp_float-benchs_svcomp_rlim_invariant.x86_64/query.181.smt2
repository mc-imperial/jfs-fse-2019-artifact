...
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ...
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))))
  (not (fp.isNaN a!1))))
(assert (not (fp.isNaN ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3))))
(assert (let ((a!1 (fp.sub roundNearestTiesToEven
                   ((_ to_fp 8 24) symbolic_0_float_4_ackermann!4)
                   (fp.sub roundNearestTiesToEven
                           (fp.sub roundNearestTiesToEven
                                   ...
                                   ((_ to_fp 8 24)
                                     symbolic_0_float_1_ackermann!6))
                           ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0)))))
  (not (fp.lt a!1 ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3)))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0))
                   ((_ to_fp 8 24) symbolic_0_float_5_ackermann!3))))
(let ((a!2 (not (fp.isNaN (fp.sub roundNearestTiesToEven
                                  ((_ to_fp 8 24)
                                    symbolic_0_float_6_ackermann!1)
                                  a!1))))
      (a!3 (not (fp.lt (fp.sub roundNearestTiesToEven
                               ((_ to_fp 8 24) symbolic_0_float_6_ackermann!1)
                               a!1)
                       ((_ to_fp 8 24) symbolic_0_float_7_ackermann!5)))))
(let ((a!4 (and a!2
