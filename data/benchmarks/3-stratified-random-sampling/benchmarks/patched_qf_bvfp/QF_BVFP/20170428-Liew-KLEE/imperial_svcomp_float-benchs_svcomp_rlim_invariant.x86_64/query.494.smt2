...
(assert (not (fp.isNaN (fp.sub roundNearestTiesToEven
                       ((_ to_fp 8 24) symbolic_0_float_ackermann!8)
                       ((_ to_fp 8 24) #x00000000)))))
(assert (not (fp.isNaN ((_ to_fp 8 24) symbolic_0_float_1_ackermann!7))))
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.sub roundNearestTiesToEven
                           ...
                           ((_ to_fp 8 24) symbolic_0_float_3_ackermann!0))
                   ((_ to_fp 8 24) symbolic_0_float_5_ackermann!4))))
(let ((a!2 (fp.isNaN (fp.sub roundNearestTiesToEven
                             ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)
                             (fp.sub roundNearestTiesToEven
                                     a!1
                                     ((_ to_fp 8 24)
                                       symbolic_0_float_7_ackermann!6)))))
      (a!3 (fp.gt (fp.sub roundNearestTiesToEven
                          ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)
                          (fp.sub roundNearestTiesToEven
                                  a!1
                                  ((_ to_fp 8 24)
...
(let ((a!2 (fp.isNaN (fp.sub roundNearestTiesToEven
                             ...
                             (fp.sub roundNearestTiesToEven
                                     ...
                                     ((_ to_fp 8 24)
                                       symbolic_0_float_7_ackermann!6)))))
      (a!3 (fp.lt (fp.sub roundNearestTiesToEven
                          ((_ to_fp 8 24) symbolic_0_float_8_ackermann!9)
                          (fp.sub roundNearestTiesToEven
                                  a!1
                                  ((_ to_fp 8 24)
                                    symbolic_0_float_7_ackermann!6)))
                  ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1))))
  (not (or a!2 (fp.isNaN ((_ to_fp 8 24) symbolic_0_float_9_ackermann!1)) a!3)))))
; End constraints
(check-sat)
(exit)
