...
(assert (= v_SqrtR_~hn~7_1_const_1931197805
...
(assert (let ((a!1 (fp.add roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           ...
                           v_SqrtR_~hn~7_1_const_1931197805)
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) roundNearestTiesToEven 6.0)
                                   v_SqrtR_~hn~7_1_const_1931197805)
                           v_SqrtR_~hn~7_1_const_1931197805)))
      (a!2 (fp.mul roundNearestTiesToEven
                   (fp.mul roundNearestTiesToEven
                           (fp.mul roundNearestTiesToEven
                                   ((_ to_fp 11 53) roundNearestTiesToEven 5.0)
                                   v_SqrtR_~hn~7_1_const_1931197805)
                           v_SqrtR_~hn~7_1_const_1931197805)
                   v_SqrtR_~hn~7_1_const_1931197805)))
(let ((a!3 (fp.add roundNearestTiesToEven
                   ...
                   (fp.div roundNearestTiesToEven
                           ...
                           ((_ to_fp 11 53) roundNearestTiesToEven 16.0)))))
